...
public class ExternalVeterinarian {
    ...
    public boolean existsVeterinarianBySpeciality(ServiceName speciality) {
        try {
            restTemplate.getForObject("https://pawfect-gateway-service.azurewebsites.net/veterinary-service/api/v1/veterinarians/speciality?speciality={speciality}", Object.class, speciality.name());
            return true;
        } catch (HttpClientErrorException.NotFound e) {
            return false;
        }
